    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationUserCommunity", x => new { x.CommunitiesId, x.ManagersId });
                    table.ForeignKey(
                        name: "FK_ApplicationUserCommunity_AspNetUsers_ManagersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearRenovated = table.Column<int>(type: "INTEGER", nullable: false),
                    IsFurnished = table.Column<bool>(type: "INTEGER", nullable: false),
                    HasParking = table.Column<bool>(type: "INTEGER", nullable: false),
                    ParkingDetails = table.Column<string>(type: "TEXT", nullable: true),
                    SecurityDetails = table.Column<string>(type: "TEXT", nullable: true),
                    UtilitiesDetails = table.Column<string>(type: "TEXT", nullable: true),
                    ...
                    Laundry = table.Column<int>(type: "INTEGER", nullable: true),
                    Heating = table.Column<int>(type: "INTEGER", nullable: true),
                    Cooling = table.Column<int>(type: "INTEGER", nullable: true),
                    OutdoorSpace = table.Column<int>(type: "INTEGER", nullable: true),
                    BaseRent = table.Column<decimal>(type: "TEXT", nullable: false),
                    BaseDeposit = table.Column<decimal>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUserCommunity_ManagersId",
